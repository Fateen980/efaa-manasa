...
<head>
    ...
    <title>
        المنصة الوطنية للمخالفات (منصةإيفاء) | اتصل بنا
    </title>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="MsUdgODdZUdmo8VfcDTebAMzUjXAyMuQR+mChcHfuCz28TrLYB6qkTG7Lk/SgsRbAHavAGTp3mgMeDnXtAc1i59nNHEZOB7vr20fuVE+2B7qNO3W9RZPJRxEnVqB03bl57V9UB5aJ8a13KzXIySQFNPP19b3UXSEFdInYWbngNJBw8vHN8akMjGrkIY83JgWiXwxfir2xA/ELgEmMbRu9g==" />
</div>
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
</div>

        <input type="hidden" name="ctl00$hdnReCaptchaKey" id="hdnReCaptchaKey" value="6Ldf2qIZAAAAAJsqY1h7YHckgTuTxqUPHw7IQJlz" />
        <input type="hidden" name="ctl00$hfMotivProgEndDate" id="hfMotivProgEndDate" value="2025-04-19T00:00:00" />
        <input type="hidden" name="ctl00$hfMotivProgAdvEndDate" id="hfMotivProgAdvEndDate" value="2025-04-19T00:00:00" />
        ...
        <input type="hidden" name="ctl00$hfAllowObjection" id="hfAllowObjection" value="true" />
        <input type="hidden" name="ctl00$hfDGASurvey" id="hfDGASurvey" value="true" />
 ...
 <div class="se-pre-con"></div>
                ...
                <div class="droopmenu-inner">
                    ...
                    <div class="droopmenu-nav">
                        <ul class="droopmenu">
                            ...
                            <li><a href="#" onclick="DictionaryUtils.toggleLang()"><i class="fas fa-globe"></i><span data-npvmdict="lang"></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="row text-center ContactUsBox">
                ...
                <div class="container">
                    <div class="CustomModalTitle animate__animated ">
                        ...
                        <button type="button" class="btn btn-danger CustomModalClose"><i class="fa fa-times"></i>
                                <span data-npvmdict="close"></span></button>
                    </div>
                </div>
            </div>
        ...
        <input type="hidden" class="BtnProgramClick"  value="0" />
...
<!-- End Google Tag Manager -->
    ...
    <script type="text/javascript" src="../new/popup.js?v=4.18"></script>
    <script type="text/javascript" src="../new/about/Custom.js?v=4.18"></script>
